...
<div class=" sm:max-w-md border-blue-300 shadow-md px-16 border m-auto rounded-lg">
  <div class="sm:mx-auto ">
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">new payroll account</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto   ">
    ...
    <p class="mt-10 p-10 text-center text-sm text-gray-500">
      are you member?
      <a href="{{route('userloginpage')}}" class="font-semibold  leading-6 text-indigo-600 hover:text-indigo-500">login for account </a>
    </p>
  </div>
</div>
</div>
